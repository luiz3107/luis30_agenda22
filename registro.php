...
<div class="register-box">
  <div class="register-logo">
    <a href="../../index2.html"><b>Biel12_agenda</b>infor2022</a>
  </div>
                  ...
                  if(isset($_POST['btnCContato'])){
                    ...
                    if(in_array($extensao,$formatP)){
                      ...
                      if(move_uploaded_file($temporario, $pasta.$novoNome)){
                        $cadastro="INSERT INTO tb_usuario(nome_usuario,email_usuario,foto_usuario,senha_usuario) VALUES(:nome,:email,:foto,:senha)";                   
                        try{
